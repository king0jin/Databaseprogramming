    ...
    <div class="menu-container" id="menu-container">
        <button class="menu-item-card1">
            <div class="menu-item-background">
                ...
                <div class="menu-item-name">B.L.T샌드위치</div>
		...
		<div id="sand1" class="modal">
	        <div class="modal-content">
	            <span class="close" onclick="closeModal('sand1')">&times;</span>
	            <p>B.L.T샌드위치</p>
	        </div>
	        <div class="quantity">
                <label for="sand1Quantity">수량 :</label>
                <input type="number" id="sand1Quantity" name="quantity" value="0" min="0" max="5">
            </div>   
                <button id="addToCartsand1" class="add-to-cart">장바구니</button>
                <button onclick="closeModal('sand1')" class="add-to-cart">닫기</button>	
         </div>
        
         <script src="javascript/THEBAKEpagesand.js"></script>
		 <script src="javascript/THEBAKEpagesandmodal.js"></script>
