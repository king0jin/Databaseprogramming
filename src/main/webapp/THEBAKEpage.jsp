...
<div class="mainpage">
    ...
    <div class="menu-container" id="menu-container">
		...
		<div id="bakery1" class="modal">
	        <div class="modal-content">
	            <span class="close" onclick="closeModal('bakery1')">&times;</span>
	            <p>모카번</p>
	        </div>
	        <div class="quantity">
                <label for="bakery1Quantity">수량 :</label>
                <input type="number" id="bakery1Quantity" name="quantity" value="0" min="0" max="5">
            </div>   
                <button id="addToCartbakery1" class="add-to-cart">장바구니</button>
                <button onclick="closeModal('bakery1')" class="add-to-cart">닫기</button>	
         </div>
        
         <script src="javascript/THEBAKEpage.js"></script>
		 <script src="javascript/THEBAKEpagemodal.js"></script>
