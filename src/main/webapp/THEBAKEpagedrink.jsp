...
<div class="mainpage">
    <ul class="category">
        ...
        <li class="menu-item" id="cake" onclick="selectMenu('cake')"><a href="THEBAKEpagecake.jsp">케이크</a></li>
    </ul>
    <div class="menu-container" id="menu-container">
        <button class="menu-item-card1">
            <div class="menu-item-background">
                ...
                <div class="menu-item-name">유자아이스베리</div>
		...
		<div id="drink1" class="modal">
	        <div class="modal-content">
	            <span class="close" onclick="closeModal('drink1')">&times;</span>
	            <p>유자아이스베리</p>
	        </div>
	        <div class="quantity">
                <label for="drink1Quantity">수량 :</label>
                <input type="number" id="drink1Quantity" name="quantity" value="0" min="0" max="5">
            </div>   
                <button id="addToCartdrink1" class="add-to-cart">장바구니</button>
                <button onclick="closeModal('drink1')" class="add-to-cart">닫기</button>	
         </div>
        
         <script src="javascript/THEBAKEpagedrink.js"></script>
		 <script src="javascript/THEBAKEpagedrinkmodal.js"></script>
