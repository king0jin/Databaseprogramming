    ...
    <script>
        ...
        function decreaseQuantity(id) {
            ...
            if (quantity > 1) {
                ...
                if (quantity - 1 === 1) {
                    var minusButton = document.getElementById('minus-' + id);
                    minusButton.src = 'img/minus1.svg';
        ...
        window.onload = function() {
            ...
            for (var i = 0; i < minusElements.length; i++) {
                minusElements[i].src = 'img/minus1.svg';
    ...
    <div class="cart-item">
        ...
        <div class="item-info">
            <div class="item-image">
                <img src="img/image1.png" alt="비건야채컵밥 이미지">
            </div>
            ...
            <div class="item-quantity">
                <div class="quantity-control">
                    ...
                    <img class="plus-button" src="img/plus.svg" alt="plus" onclick="increaseQuantity(1)">
                </div>
            </div>
